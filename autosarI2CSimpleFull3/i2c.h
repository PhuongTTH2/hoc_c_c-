...
#define I2C_SERVICE_ID_MAINFUNCTION   0x10U
...
typedef enum {
    I2C_SEQUENCE_OK = 0x00U,
    I2C_SEQUENCE_PENDING = 0x01U,
    I2C_SEQUENCE_QUEUED = 0x02U,
    I2C_SEQUENCE_NACK = 0x03U,
    I2C_SEQUENCE_FAILED = 0x04U
